...
if TORCH_AVAILABLE:
    ...
    S_MIN = 0.01
    INIT_S_MAX = 100.0
    lower_bounds = torch.tensor([S_MIN, 
                                 S_MIN,
                                 S_MIN,
                                 S_MIN,
                                 1.0,
                                ...
                                dtype=torch.float64)
    upper_bounds = torch.tensor([INIT_S_MAX,
                                 INIT_S_MAX,
                                 INIT_S_MAX,
                                 INIT_S_MAX,
                                 10.0,
    ...
    class Optimizer:
        ...
        def __init__(self, review_logs: tuple[ReviewLog, ...] | list[ReviewLog]) -> None:
            """
        ...
        def compute_optimal_parameters(self) -> list[float]:
            ...
            def _update_parameters(step_losses: list, adam_optimizer: torch.optim.Adam, params: torch.Tensor, lr_scheduler: torch.optim.lr_scheduler.CosineAnnealingLR) -> None:
                """
                ...
                for card_id in card_ids:
                    ...
                    for i in range(len(card_review_history)):
                        ...
                        if len(step_losses) == mini_batch_size:
                            ...
                            _update_parameters(step_losses=step_losses, adam_optimizer=adam_optimizer, params=params, lr_scheduler=lr_scheduler)
